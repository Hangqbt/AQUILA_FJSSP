...
from GA import GA
from Instance_GA import *   # assumes: get_instance, list_available_instances, DEFAULT_DATA_DIR
...
if __name__ == '__main__':
    ...
    # Get all instance names from instances.json via Instance_GA.py helpers
