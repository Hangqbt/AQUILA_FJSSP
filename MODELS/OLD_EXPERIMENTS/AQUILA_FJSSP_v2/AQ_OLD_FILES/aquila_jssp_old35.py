...
class Aquila_Optimizer_FJSSP:
    def __init__(self, J, Processing_time, M_num, Pop_size, Maxiter):
        ...
        Features Logarithmic Decay, Greedy MG, Plateau Walking, and High-Altitude Lévy Scatter.
        """
        self.J = J
    ...
    def optimize(self):
        ...
        while iter_num <= self.Maxiter:
            ...
            for i in range(self.N):
                ...
                # --- PLATEAU WALKING ENABLED (<= instead of <) ---
            ...
            if stagnation_counter >= 15:
                ...
                # ==========================================================
                # --- THE "HIGH-ALTITUDE SOAR" (LÉVY SCATTER) ---
                # ==========================================================
                # If the hunting ground is dead, the trailing eagles catch a thermal
                # and glide to a new territory using a massive Lévy flight mutation burst.
                if not improved_in_sledgehammer:
                    ...
                    for w_idx in worst_indices:
                        # A massive 20% geographical jump to clear the local minimum crater
