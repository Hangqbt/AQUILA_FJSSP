...
class Aquila_Optimizer_FJSSP:
    def __init__(self, J, Processing_time, M_num, Pop_size=30, Maxiter=500):
        ...
        Includes Dimensional Preservation (CR) and Discrete Local Search.
        """
        self.J = J
        ...
        # --- NEW PARAMETER: Dimensional Preservation Rate ---
        self.CR = 0.20  # Only allow eagles to change 20% of their operations per flight
    ...
    def local_search(self, best_cont_vector, current_best_fit):
        """
        Intensified Discrete Local Search.
        Attempts 50 targeted swaps to actively physically improve the schedule.
        """
    ...
    def optimize(self):
        ...
        while iter_num <= self.Maxiter:
            ...
            for i in range(self.N):
                ...
                # --- THE BREAKTHROUGH FIX: Dimensional Preservation ---
                # Stop the schedule from being completely destroyed. Only update 20% of the variables.
                for j in range(self.D):
                    if random.random() > self.CR:
                        XNEW[i, j] = X[i, j]  # Keep the old, stable value 80% of the time
            ...
            # The Alpha eagle runs a deep discrete neighborhood search to carve out further shortcuts
