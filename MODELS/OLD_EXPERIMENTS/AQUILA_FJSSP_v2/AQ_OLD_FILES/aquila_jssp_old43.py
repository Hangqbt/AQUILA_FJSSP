...
class Aquila_Optimizer_FJSSP:
    def __init__(self, J, Processing_time, M_num, Pop_size, Maxiter):
        ...
        Features: Pure old28 Physics (Alpha-Swarming + Blind Tabu)
        Upgrades: Plateau Walking (<=) and Uncapped 500 Iterations.
        """
        self.J = J
            ...
            for i in range(self.N):
                ...
                if iter_num <= (0.666 * self.Maxiter):
                    if random.random() < 0.5:
                        ...
                        # OLD28 PHYSICS: Aggressively swarm the Alpha!
                ...
                # THE PASSIVE UPGRADE: Plateau Walking
