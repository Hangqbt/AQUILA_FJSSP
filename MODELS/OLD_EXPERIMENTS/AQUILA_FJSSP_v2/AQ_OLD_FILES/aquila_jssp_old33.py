...
class Aquila_Optimizer_FJSSP:
    def __init__(self, J, Processing_time, M_num, Pop_size, Maxiter):
        ...
        Features Pure Logarithmic Decay, 80/20 Hybrid MG, and Phase-Aware Early Stopping.
        """
        self.J = J
    ...
    def optimize(self):
        ...
        while iter_num <= self.Maxiter:
            ...
            # ALLOW 100 ITERATIONS OF PATIENCE, BUT ONLY IN THE LATE GAME (After 50% mark)
