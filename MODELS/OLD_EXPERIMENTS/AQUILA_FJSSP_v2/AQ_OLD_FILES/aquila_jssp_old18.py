...
class Aquila_Optimizer_FJSSP:
    def __init__(self, J, Processing_time, M_num, Pop_size, Maxiter):
        """
        Native Discrete Aquila Optimizer (ND-AO) + Sledgehammer Tabu.
        No continuous translation, no heavy heuristics. Pure brute-force discrete swapping.
        """
        self.J = J
    ...
    def local_search(self, best_MS, best_OS, current_best_fit, num_steps, neighbors_per_step=10):
        ...
        tabu_list = []
        tabu_tenure = 7  # Slightly increased memory for the deeper drill
        ...
        for _ in range(num_steps):
            ...
            for _ in range(neighbors_per_step):
                ...
                # Pure blind swapping, highly efficient in Python
    ...
    def optimize(self):
        ...
        while iter_num <= self.Maxiter:
            ...
            if Bestfitval >= previous_best_fit:
                ...
                # --- DYNAMIC SLEDGEHAMMER BUDGET ---
            tabu_steps = 10  # Base sweep (100 evals)
            neighbors_per_step = 10

            if stagnation_counter >= 15:
                tabu_steps = 100  # MASSIVE SLEDGEHAMMER (2,000 evals)
                neighbors_per_step = 20  # Wider search radius
                stagnation_counter = 0
