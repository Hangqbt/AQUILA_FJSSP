...
class Aquila_Optimizer_FJSSP:
    def __init__(self, J, Processing_time, M_num, Pop_size, Maxiter):
        """
        Original Aquila Optimizer (AO) + Tabu Search (TS).
        Preserves the exact 4 phases of continuous AO, with Discrete Tabu applied to the Alpha.
        """
        self.J = J
    ...
    def local_search(self, best_cont_vector, current_best_fit):
        """
        --- Discrete Tabu Search (TS) ---
        Applied directly to the Alpha eagle to untangle discrete schedules.
        """
    ...
    def optimize(self):
        ...
        while iter_num <= self.Maxiter:
            ...
            # --- THE 4 STAGES OF ORIGINAL AQUILA OPTIMIZER ---
            ...
            # --- HYBRIDIZATION: DISCRETE TABU SEARCH ---
            # Once the swarm finishes its 4-stage flight, Tabu untangles the Alpha
