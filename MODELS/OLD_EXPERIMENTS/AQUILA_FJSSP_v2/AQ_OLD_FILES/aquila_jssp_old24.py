...
class Aquila_Optimizer_FJSSP:
    def __init__(self, J, Processing_time, M_num, Pop_size, Maxiter):
        ...
        Features Exponential Decay for Stage 1 Exploration and Phase-Dependent Local Search.
        """
        self.J = J
        ...
        while iter_num <= self.Maxiter:
            ...
            for i in range(self.N):
                ...
                if iter_num <= (0.666 * self.Maxiter):
                    if random.random() < 0.5:
                        # EXPONENTIAL DECAY: Replaces linear decay.
                        # Drops chaos rapidly, allowing the swarm to settle faster.
                        Pc = math.exp(-5.0 * (iter_num / self.Maxiter))
            ...
            if stagnation_counter >= 15:
                ...
                # The 5-step Tabu wakes up ONLY in the final 33% of the optimization!
