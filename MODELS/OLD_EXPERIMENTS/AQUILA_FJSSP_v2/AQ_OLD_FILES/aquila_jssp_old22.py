...
class Aquila_Optimizer_FJSSP:
    def __init__(self, J, Processing_time, M_num, Pop_size, Maxiter):
        ...
        Tabu search remains ASLEEP 90% of the time to preserve computational speed.
        """
        self.J = J
    ...
    def optimize(self):
        ...
        while iter_num <= self.Maxiter:
            ...
            if Bestfitval >= previous_best_fit:
                ...
                # ==========================================================
            # --- THE "ASLEEP-UNTIL-NEEDED" DYNAMIC TABU TRIGGER ---
            # ==========================================================
            if stagnation_counter >= 15:
                # SLEDGEHAMMER (Massive crater-clearing drill)
                BEST_MS, BEST_OS, Bestfitval = self.local_search(BEST_MS, BEST_OS, Bestfitval, num_steps=100,
                                                                 neighbors_per_step=20)
                stagnation_counter = 0

            else:
                # ULTRA-LIGHT CONSTANT MAINTENANCE
                # Only 2 steps! Mathematically tuned to hit exactly ~60 seconds on mk15.
                BEST_MS, BEST_OS, Bestfitval = self.local_search(BEST_MS, BEST_OS, Bestfitval, num_steps=2,
