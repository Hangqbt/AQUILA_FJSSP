...
class Aquila_Optimizer_FJSSP:
    def __init__(self, J, Processing_time, M_num, Pop_size, Maxiter):
        ...
        Features: 20% GS Init, 80/20 Sledgehammer, Swarm Personal Memory + OS Co-Mutation.
        UPGRADE: Aggressive 50-Iteration Early Stopper (~20% limit).
        """
        self.J = J
    ...
    def optimize(self):
        ...
        while iter_num <= self.Maxiter:
            ...
            # =========================================================
            # AGGRESSIVE EARLY STOPPING (50 Iterations / ~20% buffer)
            # =========================================================
            if Bestfitval < previous_best_fit:
                global_stagnation = 0
            else:
            ...
            if global_stagnation >= 50 and iter_num > (0.2 * self.Maxiter):
