...
class Aquila_Optimizer_FJSSP:
    def __init__(self, J, Processing_time, M_num, Pop_size, Maxiter):
        ...
        Features EXPONENTIAL DECAY (-2.0), GREEDY MG, Plateau Walking, and 200-Iter Runway.
        """
        self.J = J
    ...
    def optimize(self):
        ...
        while iter_num <= self.Maxiter:
            ...
            for i in range(self.N):
                ...
                if iter_num <= (0.666 * self.Maxiter):
                    if random.random() < 0.5:
                        ...
                        # REVERTED TO DUAL EXPONENTIAL DECAY (-2.0)
            ...
            # EARLY STOPPING EXTENDED TO 200 ITERATIONS
