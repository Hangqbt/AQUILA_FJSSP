...
if __name__ == '__main__':
    ...
    if RUN_MODE == 'SINGLE':
        out_path = ROOT_DIR / f"ao_results_single_{TARGET_INSTANCE}_run{timestamp}.csv"
    elif RUN_MODE == 'AUTHOR':
        out_path = ROOT_DIR / f"ao_results_author_{TARGET_AUTHOR}_run{timestamp}.csv"
    else:
        out_path = ROOT_DIR / f"ao_results_ALL_run{timestamp}.csv"
