...
class Aquila_Optimizer_FJSSP:
    def __init__(self, J, Processing_time, M_num, Pop_size, Maxiter):
        ...
        Features Pure Logarithmic Decay, 80/20 Hybrid MG, and 50-Iter Early Stopping.
        """
        self.J = J
    ...
    # =========================================================================
    # 80/20 HYBRID TABU SEARCH (Random Fast Swaps + MG Critical Path)
    # =========================================================================
    ...
    def optimize(self):
        ...
        global_stagnation = 0  # NEW: Tracks absolute flatlining for early exit
        convergence_history = []
        ...
        while iter_num <= self.Maxiter:
            ...
            for i in range(self.N):
                ...
                if iter_num <= (0.666 * self.Maxiter):
                    if random.random() < 0.5:
                        # =======================================================
                        # PURE LOGARITHMIC DECAY
                        # Rapid initial plummet to force scatter, long steady coast.
                        # =======================================================
            ...
            if Bestfitval >= previous_best_fit:
                ...
                # ==========================================================
            # --- THE "TOP 10% MULTI-DRILL" HYBRID TABU ENGINE ---
            # ==========================================================
            ...
            # If the algorithm has truly flatlined for 50 straight iterations, kill it to save CPU time!
            if global_stagnation >= 50:
                print(f"Early Stopping Triggered at Iteration {iter_num}!")
                # Pad the convergence array so the PDF grapher doesn't crash from mismatched lengths
                while iter_num <= self.Maxiter:
                    convergence_history.append(Bestfitval)
                    iter_num += 1
                break
