...
class Aquila_Optimizer_FJSSP:
    ...
    def local_search(self, best_MS, best_OS, current_best_fit, num_steps):
        """Native Discrete Tabu Search with Dynamic Budget (Deep Drill)."""
        ...
        for _ in range(num_steps):  # Budget controlled by the optimizer loop
            neighborhood = []
    ...
    def optimize(self):
        ...
        while iter_num <= self.Maxiter:
            ...
            # =========================================================
            # --- STAGNATION TRIGGER: NATIVE DISCRETE DEEP DRILL ---
            # =========================================================
            ...
            tabu_steps = 5  # Standard sweep: 50 evals

            if stagnation_counter >= 15:
                tabu_steps = 30  # DEEP DRILL: 300 evals!
                stagnation_counter = 0
                # =========================================================

            # Apply Discrete Tabu Search dynamically
