...
class Aquila_Optimizer_FJSSP:
    def __init__(self, J, Processing_time, M_num, Pop_size, Maxiter):
        ...
        Features Logarithmic Decay, DYNAMIC WORKLOAD MG, Plateau Walking, and Lévy Scatter.
        """
        self.J = J
    ...
    # =========================================================================
    # DYNAMIC WORKLOAD HYBRID TABU SEARCH
    # =========================================================================
            ...
            for _ in range(neighbors_per_step):
                ...
                if use_mg_heuristic and cp and len(cp) > 1:
                    ...
                    if random.random() < 0.5:
                        # DYNAMIC LEAST-QUEUED MACHINE REASSIGNMENT
                        flat_idx = 0
                        ...
                        if valid_machines:
                            ...
                            # To prevent deterministic neighborhood collapse, pick randomly from the top 3 best machines
