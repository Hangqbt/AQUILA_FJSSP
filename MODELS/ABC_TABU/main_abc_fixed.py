...
if __name__ == "__main__":
    ...
    df_results.to_csv("abc_tabu_benchmark_results.csv", index=False)
    df_seedwise.to_csv("abc_tabu_seedwise_fitness_results.csv", index=False)
    df_seedwise_time.to_csv("abc_tabu_seedwise_time_results.csv", index=False)
