...
def generate_detailed_excel():
    ...
    files = {
        "AO Tabu (50/50/50/50)": "ao_benchmark_results_50prob.csv",
        "AO No Hybrid (50/50/50/50)": "ao_no_hybrid_benchmark_results_50prob.csv",
        "AO Tabu (50/50/60/60)": "ao_benchmark_results.csv",
        "AO No Hybrid (50/50/60/60)": "ao_no_hybrid_benchmark_results.csv"
    }
    ...
    output_path = "Detailed_Benchmark_Analysis.xlsx"
