...
def generate_ga_detailed_excel():
    # 1. Map your GA algorithms to their specific CSV filenames
    files = {
        "GA (60/20/20)": "ga_benchmark_results.csv",
        "GA Tabu (60/20/20)": "ga_tabu_benchmark_results.csv",
        "GA (25/25/50)": "ga_benchmark_results_newinit.csv",
        "GA Tabu (25/25/50)": "ga_tabu_benchmark_results_new_init.csv"
    }
    ...
    for name, filepath in files.items():
        try:
            ...
            # Keep original mean ± std as strings for the raw tab
    ...
    output_path = "Detailed_GA_Init_Analysis.xlsx"
